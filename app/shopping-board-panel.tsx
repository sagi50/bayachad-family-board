...
export default function ShoppingBoardPanel(){
  ...
  return createPortal(<>
    <style>{`
      ...
      .shopping-mini-tabs{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:8px;padding:14px 14px 6px;min-width:0}.shopping-mini-tab{min-width:0;border:1px solid #e7d7c8;background:#fffaf5;border-radius:14px;padding:10px 8px;font:inherit;color:#687086;display:flex;align-items:center;justify-content:center;gap:6px;cursor:pointer}.shopping-mini-tab.active{background:#f3e3d2;color:#7d4e2d;border-color:#c49a75;font-weight:700}.shopping-mini-count{flex:0 0 auto;min-width:22px;height:22px;border-radius:999px;background:rgba(255,255,255,.72);display:inline-grid;place-items:center;font-size:12px}
      .shopping-products{padding:10px 14px 16px;display:flex;flex-direction:column;gap:9px;min-width:0}.shopping-product{display:grid;grid-template-columns:minmax(0,1fr) auto auto;align-items:center;gap:8px;padding:12px;border:1px solid #eee2d8;border-radius:14px;background:#fff;min-width:0;box-sizing:border-box}.shopping-product-main{min-width:0;overflow:hidden}.shopping-product-name{font-weight:750;color:#34271f;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.shopping-product-note{font-size:12px;color:#8a8f9d;margin-top:3px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.shopping-qty{flex:0 0 auto;max-width:100px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;background:#f5eadf;color:#795033;border-radius:999px;padding:6px 9px;font-size:13px;font-weight:700}.shopping-actions{display:flex;gap:5px;flex:0 0 auto}.shopping-action{width:34px;height:34px;border:1px solid #eadfd6;background:#fffaf6;border-radius:9px;display:grid;place-items:center;color:#7b6556;cursor:pointer;padding:0}.shopping-action.danger{color:#b54e46}.shopping-action:hover{background:#f5eadf}
      ...
      @media(max-width:760px){
        ...
        .shopping-mini-tabs{padding:10px 10px 4px;gap:7px}.shopping-mini-tab{font-size:13px;padding:10px 6px;white-space:nowrap}
        .shopping-products{padding:10px;gap:8px}
        .shopping-product{grid-template-columns:minmax(0,1fr) auto;grid-template-areas:'main qty' 'actions actions';gap:8px 10px;padding:11px 10px}
        .shopping-product-main{grid-area:main}.shopping-qty{grid-area:qty;max-width:90px;font-size:12px;padding:5px 8px}.shopping-actions{grid-area:actions;width:100%;display:grid;grid-template-columns:1fr 1fr;gap:8px;padding-top:2px}
        .shopping-action{width:100%;height:36px;display:flex;align-items:center;justify-content:center;gap:6px;font-size:12px}
        .shopping-action::after{content:attr(data-label)}
        .shopping-product-name{font-size:15px}.shopping-product-note{font-size:12px;white-space:normal;overflow:visible;text-overflow:clip;line-height:1.4}
      ...
      @media(max-width:420px){
        ...
        .shopping-product{padding:10px 9px}
        .shopping-qty{max-width:76px}
      }
    `}</style>
