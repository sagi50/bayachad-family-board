...
export type Task = { id:string; title:string; details:string; topic:string; location:string; due:string; assignee:string; status:Status; updated_at:string; updated_by:string; version:number };
